...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center lg:gap-10 secondary-font relative">
      ...
      >
        <h1 className="text-blue-600 md:text-5xl text-3xl font-semibold">
          Digital Solutions That Drive Business Growth
        </h1>
        <p className="text-xl mt-5 text-zinc-600 primary-font">
          From software development to automation, SEO, and digital marketing, we build custom solutions to help your business scale, streamline, and succeed.
        </p>
