...
const NavBar = () => {
  ...
  return (
    <div className="w-full xl:h-24 lg:h-20 h-16 flex flex-row items-center justify-between lg:px-32 sm:px-20 px-10 shadow-lg relative secondary-font">
      ...
      <a
        href="/"
        className="lg:text-3xl text-2xl tracking-wide font-light text-blue-600"
      >
        Neoloxic
      </a>
      {/* menu */}
      <div className="lg:flex items-center justify-between lg:gap-14 hidden">
        <a
          href="/"
          className="text-blue-800 hover:text-[#EE7540] text-lg tracking-wide font-light"
        >
          Home
        </a>
        <a
        ...
        {/* CTA */}
        {/* <button className="bg-green-400 text-lg text-slate-50 rounded-3xl px-4 py-1">
          Get Strated
        </button> */}
