...
const Portfolio = () => {
  ...
  return (
    <div className="text-blue-600">
      ...
      Explore our work—crafted with precision, innovation, and a commitment to digital excellence.
      From web development to AI automation, our projects showcase the power of technology-driven solutions.
      </p>
